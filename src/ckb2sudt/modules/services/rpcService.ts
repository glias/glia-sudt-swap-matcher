...
import {CKB_NODE_URL, PW_LOCK_CODE_HASH, PW_LOCK_HASH_TYPE} from '../../utils/workerEnv'
import {OutPoint} from '@ckb-lumos/base'
import {scriptToHash} from '@nervosnetwork/ckb-sdk-utils'
import JSONbig from 'json-bigint'
import {workerLogger} from '../../utils/workerLogger'
import {prepare0xPrefix, remove0xPrefix, waitTx} from '../../../tools'
...
export default class RpcService {
    ...
    sendTransaction = async (rawTx: CKBComponents.RawTransaction): Promise<boolean> => {
        try {
            ...
            this.#info(`sendTransaction, txHash: ${txHash} ....done!`)
            return true
        } catch (e) {
