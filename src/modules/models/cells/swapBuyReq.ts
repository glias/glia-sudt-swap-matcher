...
lock: - 138 bytes
    ...
    args: sudt_y_type_hash (32 bytes, 0..32)
        ...
        | tips(8 bytes, 81..89)
        | tips_sudt_x (16 bytes, 89..105)
 */

export class SwapBuyReq implements CellInputType {
    static SWAP_BUY_REQUEST_FIXED_CAPACITY = BigInt(227 * 10 ** 8)

    //total capacity the req holds
    capacity: bigint

    sudtXInAmount: bigint
    ...
    constructor(
        ...
        this.sudtXInAmount = sudtXInAmount
    ...
    static fromCell(cell: Cell, script: CKBComponents.Script): SwapBuyReq | null {
        ...
        let sudtXInAmount = leHexToBigIntUint128(cell.data)
    ...
    static default(): SwapBuyReq {
        return new SwapBuyReq(0n, 0n, '', '', '', 0n, 0n, 0n, defaultScript(), defaultOutPoint())
    }
